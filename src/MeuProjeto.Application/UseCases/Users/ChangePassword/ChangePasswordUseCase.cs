...
namespace MeuProjeto.Application.UseCases.Users.ChangePassword
{
    public class ChangePasswordUseCase : IChangePasswordUseCase
    {
        ...
        public ChangePasswordUseCase(IUnitOfWork uow, IUserRepository repo, ILoggedUser loggedUser, IValidator<ChangePasswordRequestDto> validator, IPasswordHasher passwordHasher)
        {
            _uow = uow;
            _repo = repo;
